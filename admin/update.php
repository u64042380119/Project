...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            <p>รหัสผ่านเก่า :</p>
            <input type="password" name="old_pass" placeholder="กรอกรหัสผ่านเก่าของคุณ" maxlength="20"  class="box">
            <p>รหัสผ่านใหม่ :</p>
            <input type="password" name="new_pass" placeholder="กรอกรหัสผ่านใหม่ของคุณ" maxlength="20"  class="box">
            <p>ยืนยันรหัสผ่าน :</p>
            <input type="password" name="cpass" placeholder="ยืนยันรหัสผ่านใหม่ของคุณ" maxlength="20"  class="box">
         </div>
      </div>
      <p>อัพเดทภาพ :</p>
      <input type="file" name="image" accept="image/*"  class="box">
      <input type="submit" name="submit" value="อัปเดตตอนนี้" class="btn">
   </form>
