...
<section class="contents">
   ...
   <h1 class="heading">เนื้อหาของคุณ</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">สร้างเนื้อหาใหม่</h3>
      <a href="add_content.php" class="btn">เพิ่มเนื้อหา</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">ดูเนื้อหา</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">ยังไม่มีการเพิ่มเนื้อหา!</p>';
      }
   ?>
