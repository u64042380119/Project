   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <a href="update_content.php?get_id=<?= $video_id; ?>" class="option-btn">อัปเดต</a>
            <input type="submit" value="ลบ" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">ยังไม่มีการเพิ่มเนื้อหา! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
...
<section class="comments">
   ...
   <h1 class="heading">ความคิดเห็นของผู้ใช้</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');">ลบความคิดเห็น</button>
         </form>
      </div>
      <?php
       }
